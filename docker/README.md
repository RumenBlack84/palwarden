...
`PLAYER_STATS_INTERVAL` (seconds between save-derived stats refreshes,
default 60; embedded mode only — build with `WITH_PLAYER_STATS=false` for a
leaner image whose Players page reports stats as unavailable),
