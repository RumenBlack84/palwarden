...
echo "     Save-derived player stats for the web UI's Players page (needs the"
echo "     optional pyooz codec — see docs/tools.md#palworld-player-stats):"
echo "       systemctl enable --now palworld-player-stats.timer"
